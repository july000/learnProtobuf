...
const Person_PhoneType Person::PHONE_TYPE_UNSPECIFIED;
const Person_PhoneType Person::PHONE_TYPE_MOBILE;
const Person_PhoneType Person::PHONE_TYPE_HOME;
const Person_PhoneType Person::PHONE_TYPE_WORK;
